...
<head>
    <title>Code coverage report for src/stores/dir.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/stores</a> dir.ts</h1>
        <div class='clearfix'>
...
<a name='L575'></a><a href='#L575'>575</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >      throw new Error(`Invalid prompt filename format: ${filename}`);</span>
...
<span class="cstat-no" title="statement not covered" >            `Skipping file with invalid name format: ${file}`,</span>
    ...
    for (const file of files) {
      ...
      if (this.isPartial(baseName)) {
        try {
          ...
          // Construct full name including relative directory path, using /.
          const fullName =
            dirPath !== <span class="branch-0 cbranch-no" title="branch not covered" >'.'</span>
<span class="cstat-no" title="statement not covered" >              ? `${dirPath.replace(/\\/g, '/')}/${parsedName}`</span>
              : parsedName;
          const content = await this.readPromptFile(
            path.join(this.directory, file)
          );
...
<span class="branch-0 cbranch-no" title="branch not covered" >        } catch (error) {</span>
          // Log or handle files with invalid names, skipping them.
<span class="cstat-no" title="statement not covered" >          console.warn(</span>
<span class="cstat-no" title="statement not covered" >            `Skipping partial file with invalid name format: ${file}`,</span>
<span class="cstat-no" title="statement not covered" >            error</span>
<span class="cstat-no" title="statement not covered" >          );</span>
<span class="cstat-no" title="statement not covered" >        }</span>
      }
      ...
      if (options?.version &amp;&amp; options.version !== version) {
        throw new Error(
          `Version mismatch for prompt '${name}'` +
            `${<span class="branch-0 cbranch-no" title="branch not covered" >variant ? ` (variant: ${variant})` : '</span>'}` +
...
&nbsp;
      ...
      const variantInfo = <span class="branch-0 cbranch-no" title="branch not covered" >variant ? ` (variant: ${variant})` : '</span>';
      const versionInfo = options?.version
        ? ` (version: ${options.version<span class="branch-0 cbranch-no" title="branch not covered" >})`</span>
<span class="cstat-no" title="statement not covered" >        : '';</span>
      const message = error instanceof Error ? error.<span class="branch-0 cbranch-no" title="branch not covered" >message : String(error);</span>
      // Specifically check for file not found errors.
      if ((error as NodeJS.ErrnoException).code === 'ENOENT') <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >        throw new Error(</span>
<span class="cstat-no" title="statement not covered" >          `Prompt '${name}'${variantInfo}${versionInfo} ` +</span>
<span class="cstat-no" title="statement not covered" >            `not found at path: ${filePath}`</span>
<span class="cstat-no" title="statement not covered" >        );</span>
<span class="cstat-no" title="statement not covered" >      }</span>
...
&nbsp;
    ...
    const fileName = <span class="branch-0 cbranch-no" title="branch not covered" >variant</span>
<span class="cstat-no" title="statement not covered" >      ? `_${baseName}.${variant}.prompt`</span>
      : `_${baseName}.prompt`;
    // Construct the full path relative to the store's base directory.
    const filePath = path.join(this.directory, dirName, fileName);
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        : '';</span>
      ...
      if ((error as NodeJS.ErrnoException).code === 'ENOENT') <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >        throw new Error(</span>
<span class="cstat-no" title="statement not covered" >          `Partial '${name}'${variantInfo}${versionInfo} ` +</span>
<span class="cstat-no" title="statement not covered" >            `not found at path: ${filePath}`</span>
<span class="cstat-no" title="statement not covered" >        );</span>
<span class="cstat-no" title="statement not covered" >      }</span>
      // General loading failure.
...
&nbsp;
  ...
  async save(prompt: PromptData): Promise&lt;void&gt; {
    ...
    if (prompt.source === undefined || prompt.source === null) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('Prompt source content is required for saving.');</span>
<span class="cstat-no" title="statement not covered" >    }</span>
&nbsp;
...
<span class="branch-0 cbranch-no" title="branch not covered" >    } catch (error: unknown) {</span>
      // Create more informative error messages.
<span class="cstat-no" title="statement not covered" >      const variantInfo = prompt.variant ? ` (variant: ${prompt.variant})` : '';</span>
<span class="cstat-no" title="statement not covered" >      const message = error instanceof Error ? error.message : String(error);</span>
<span class="cstat-no" title="statement not covered" >      throw new Error(</span>
<span class="cstat-no" title="statement not covered" >        `Failed to save prompt '${prompt.name}'${variantInfo} ` +</span>
<span class="cstat-no" title="statement not covered" >          `to ${filePath}: ${message}`</span>
<span class="cstat-no" title="statement not covered" >      );</span>
<span class="cstat-no" title="statement not covered" >    }</span>
  }
&nbsp;
...
&nbsp;
    ...
    try {
      ...
      try {
        await fs.access(partialFilePath<span class="branch-0 cbranch-no" title="branch not covered" >);</span>
<span class="cstat-no" title="statement not covered" >        filePathToDelete = partialFilePath;</span>
<span class="cstat-no" title="statement not covered" >        fileType = 'partial';</span>
      } catch (accessError) {
...
<span class="cstat-no" title="statement not covered" >        const variantInfo = variant ? ` (variant: ${variant})` : '';</span>
<span class="cstat-no" title="statement not covered" >        const message = error instanceof Error ? error.message : String(error);</span>
<span class="cstat-no" title="statement not covered" >        throw new Error(</span>
<span class="cstat-no" title="statement not covered" >          `Failed to delete ${fileType} '${name}'${variantInfo} ` +</span>
<span class="cstat-no" title="statement not covered" >            `at ${filePathToDelete}: ${message}`</span>
<span class="cstat-no" title="statement not covered" >        );</span>
<span class="cstat-no" title="statement not covered" >      }</span>
    }
    ...
    // something is wrong.
    if (!filePathToDelete) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >      const variantInfo = variant ? ` (variant: ${variant})` : '';</span>
<span class="cstat-no" title="statement not covered" >      throw new Error(</span>
<span class="cstat-no" title="statement not covered" >        `Internal error: Could not determine file path to delete for '${name}'${variantInfo}.`</span>
<span class="cstat-no" title="statement not covered" >      );</span>
<span class="cstat-no" title="statement not covered" >    }</span>
  }
}

...
<a name='L445'></a><a href='#L445'>445</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
export function convertNamespacedEntryToNestedObject(
  ...
  const result = <span class="branch-0 cbranch-no" title="branch not covered" >obj || {};</span>
&nbsp;
...
export function messageSourcesToMessages(
  ...
  return messageSources
    ...
    .map((m) =&gt; {
      const out: Message = {
        role: m.role as Role,
        content: m.content || toParts(m.<span class="branch-0 cbranch-no" title="branch not covered" >source || '')</span>,
      };
      if (m.metadata) {

...
export default function HomePage() {
  return (
    <div className="space-y-12">
      <section className="text-center py-12 bg-accent/20 rounded-lg shadow-2xl">
      ...
      <section className="max-w-4xl mx-auto space-y-8">
        ...
        <h2 className="text-4xl font-bold text-center text-foreground pt-8">Principios Fundamentales</h2>
        ...
        <h2 className="text-4xl font-bold text-center text-foreground pt-8">Figuras Clave</h2>
        <div className="grid md:grid-cols-2 gap-8">
          <Card className="shadow-md hover:shadow-lg transition-shadow duration-300">
            <CardHeader>
              <CardTitle className="text-2xl text-foreground">Jeremy Bentham (1748-1832)</CardTitle>
            </CardHeader>
            <CardContent className="text-foreground/80">
          ...
          <Card className="shadow-md hover:shadow-lg transition-shadow duration-300">
            <CardHeader>
              <CardTitle className="text-2xl text-foreground">John Stuart Mill (1806-1873)</CardTitle>
            </CardHeader>
            <CardContent className="text-foreground/80">
      ...
      <section className="max-w-4xl mx-auto space-y-8 py-12">
        <h2 className="text-4xl font-bold text-center text-foreground mb-8">Explora el Utilitarismo Visualmente</h2>
      ...
      <section className="text-center py-12">
        <h2 className="text-3xl font-bold mb-6 text-foreground">Explora Nuestro Merchandising</h2>
